...
INSERT INTO `employees` VALUES (106, 'Valli', 'P_ataballa', 'VPATABAL', '590.423.4560', '1998-02-05', 'IT_PROG', 4800.00, NULL, 103, 60);
...
CREATE TABLE `job_history`  (
  ...
  UNIQUE INDEX `jhist_emp_id_st_date_pk`(`employee_id`, `start_date`) USING BTREE,
  INDEX `jhist_job_fk`(`job_id`) USING BTREE,
  INDEX `jhist_dept_fk`(`department_id`) USING BTREE,
...
CREATE TABLE `jobs`  (
  ...
  UNIQUE INDEX `job_id_pk`(`job_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `locations`  (
  `location_id` int(0) NOT NULL DEFAULT 0,
  ...
  UNIQUE INDEX `loc_id_pk`(`location_id`) USING BTREE,
  INDEX `loc_c_id_fk`(`country_id`) USING BTREE,
...
CREATE TABLE `order`  (
  ...
  `order_name` varchar(15) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `regions`  (
  ...
  UNIQUE INDEX `reg_id_pk`(`region_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
